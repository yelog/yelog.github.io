...
shareObj = [{
    ...
    "logo": "files/qzone.ico",
    "title": "QQ空间"
}, {
    "name": "新浪微博",
    "url": "http://v.t.sina.com.cn/share/share.php?url=${url}&title=${title}",
    "logo": "files/sina_weibo.ico",
    "title": "新浪微博"
}, {
    "name": "腾讯微博",
    "url": "http://share.v.t.qq.com/index.php?c=share&a=index&title=${title}&url=${url}",
    "logo": "files/tencent_weibo.ico",
    "title": "腾讯微博"
}];
...
bookConfig.BackgroundSoundURL = "files/BackgroundSoundURL.mp3";
...
bookConfig.backGroundImgURL = "files/backGroundImgURL.jpg";
...
bookConfig.leftMarginOnMobile = "5";
bookConfig.topMarginOnMobile = "5";
bookConfig.rightMarginOnMobile = "5";
bookConfig.bottomMarginOnMobile = "5";
...
bookConfig.useTheAliCloudChart = "yes";
bookConfig.UIBaseURL = "";
bookConfig.totalPageCount = "39";
bookConfig.largePageWidth = "259";
bookConfig.largePageHeight = "396";
bookConfig.bookTitle = "多拉美2018年冬季现货产品";
bookConfig.normalPath = "./files/img/";
bookConfig.largePath = "./files/img/";
bookConfig.thumbPath = "./files/img/";
...
var pageEditor = [[], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], []];
bookConfig.CreatedTime = 1540003554;//suffix time
