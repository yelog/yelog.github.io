...
// Slugify
exports.defaultOptions = Object.assign({}, utils_1.deepClone(transliterate_1.defaultOptions), { allowedChars: 'a-zA-Z0-9-_.~', lowercase: true, separator: '-', uppercase: false });
class Slugify extends transliterate_1.Transliterate {
    get options() {
        return utils_1.deepClone(Object.assign({}, exports.defaultOptions, this.confOptions));
    }
    /**
     * Set default config
     * @param options
    ...
    slugify(str, options) {
        ...
        const opt = utils_1.deepClone(Object.assign({}, this.options, options));
